        ...
        <div className="mb-8 flex flex-col items-start gap-4">
          ...
          <div>
            <p className="text-muted-foreground mt-2">
              Aqui você pode visualizar as contas associadas a Vulkan incluindo
              detalhes como email, armazenamento utilizado e status de bloqueio.
            </p>
          </div>
        </div>
        ...
        {accounts.data?.length === 0 ? (
          <div className="text-center p-10 border rounded-lg bg-background">
            <p className="text-muted-foreground">
              Não foi possível encontrar as contas
            </p>
          </div>
        ) : (
